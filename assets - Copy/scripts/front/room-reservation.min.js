...
var jalaliStartDate = jalaliMoment(defaultStartDate, dateFormat).locale('fa').format('jYYYY-jMM-jDD');
var jalaliEndDate = jalaliMoment(defaultEndDate, dateFormat).locale('fa').format('jYYYY-jMM-jDD');
setTimeout(function(){
$('.check-in-date-show').val(jalaliStartDate);
$('.check-out-date-show').val(jalaliEndDate);
}, 3000);
