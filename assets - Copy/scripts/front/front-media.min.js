    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if ($roomSearchForm.length) {
            var dateFormat = $roomSearchForm.data('date-format') ? $roomSearchForm.data('date-format') : 'YYYY-MM-DD',
          	...
          	setTimeout(function() {
              	var jalaliStartDate = jalaliMoment($checkinDate.val(), dateFormat).locale('fa').format('jYYYY-jMM-jDD');
           		var jalaliEndDate = jalaliMoment($checkoutDate.val(), dateFormat).locale('fa').format('jYYYY-jMM-jDD');
